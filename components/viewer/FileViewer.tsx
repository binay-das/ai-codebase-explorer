  ...
  return (
    <div className="flex h-full items-center justify-center bg-zinc-950">
      <div className="text-center">
        <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-lg bg-zinc-900">
          <CodeIcon className="h-5 w-5 text-zinc-500" />
        </div>
...
function LoadingSkeleton() {
  return (
    <div className="bg-zinc-950 p-4" aria-label="Loading file content">
      {Array.from({ length: 12 }).map((_, i) => (
        ...
        >
          <div className="h-3 w-10 animate-pulse rounded bg-zinc-800 shrink-0 mr-4" />
          <div
  ...
  return (
    <div className="p-4" aria-label="Generating explanation">
      ...
      {Array.from({ length: 3 }).map((_, i) => (
        <div
          key={i}
          className="h-2.5 animate-pulse rounded bg-zinc-800 mb-2"
        ...
        <div className="flex items-center justify-between border-b border-zinc-800 px-4 py-2">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <p className="truncate text-sm font-medium text-zinc-200 font-mono">
                {fileName}
              </p>
      ...
      <div className="min-h-0 flex-1 overflow-auto">
          ...
          <div className="flex h-full items-center justify-center">
            <div className="text-center">
              <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-zinc-900">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="h-6 w-6 text-zinc-500">
                  <path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z" />
                  <polyline points="14 2 14 8 20 8" />
                </svg>
              </div>
              <p className="text-sm text-zinc-400">Binary file</p>
              <p className="mt-1 text-xs text-zinc-600">Cannot preview this file type</p>
            </div>
          </div>
        )}
        ...
        {state.status === "error" && state.tooLarge && (
          <div className="flex h-full flex-col items-center justify-center gap-2">
            <div className="mx-auto mb-2 flex h-12 w-12 items-center justify-center rounded-xl bg-amber-900/30">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="h-6 w-6 text-amber-400">
                <path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z" />
                <path d="M12 9v4" />
                <path d="M12 17h.01" />
              </svg>
            </div>
            <p className="text-sm font-medium text-amber-400">File too large</p>
        ...
        {state.status === "ready" && (
          <div className="h-full">
            {state.truncated && (
              <div className="border-b border-amber-900/50 bg-amber-950/30 px-4 py-1.5 text-xs text-amber-400/80">
              ...
              <pre className="min-h-full">
                {state.tokens.map((lineTokens, index) => {
                  ...
                  return (
                    ...
                    >
                      <span
                        className="select-none shrink-0 w-14 pl-4 pr-3 text-right text-zinc-600 text-[12px] group-hover:text-zinc-400 transition-colors border-r border-zinc-800/80 bg-zinc-900/30"
                        style={{ lineHeight: "20px" }}
                      >
                        {lineNumber}
                      </span>
                      <span
                        className="whitespace-pre-wrap break-words text-zinc-300 pl-4"
                        style={{ lineHeight: "20px" }}
                      >
